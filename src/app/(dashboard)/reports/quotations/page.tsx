  ...
  return (
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: T.ink }}>Reporte de Cotizaciones</h1>
          <p style={{ fontSize: 13, color: T.inkMuted, marginTop: 4 }}>
            Todas las cotizaciones — <span style={{ fontWeight: 600, color: T.inkSoft }}>{filtered.length} registros</span>
          </p>
        </div>
      ...
      <div className="relative max-w-sm">
        <input
          ...
          className="w-full px-4 py-2 text-sm rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 placeholder:text-slate-400"
      ...
      <div style={{ borderRadius: T.radiusMd, border: "1px solid " + T.borderLight, overflow: "hidden", boxShadow: T.shadowMd }}>
        {data.length === 0 ? (
          <div className="flex items-center justify-center py-20">
            ...
            <span style={{ marginLeft: 8, fontSize: 13, color: T.inkMuted }}>Cargando cotizaciones...</span>
          </div>
        ) : filtered.length === 0 ? (
      ...
      <p style={{ fontSize: 11, color: T.inkLight, textAlign: "center" }}>Vista previa con columnas clave · El archivo Excel contiene las 15 columnas completas</p>
    </div>
    </div>
  );
}
